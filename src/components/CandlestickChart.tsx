...
export const CandlestickChart: React.FC<CandlestickChartProps> = ({ data, loading, cryptoSymbol }) => {
  if (loading) {
    return (
    ...
    <div className="space-y-4">
      ...
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-bold text-white">{cryptoSymbol}/IDR Candlestick</h2>
